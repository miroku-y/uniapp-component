    ...
    <view class="component-content">
        ...
        <view class="button-demo">
            <view class="code-box-description">
                <view><code>type </code>语法糖</view>
                <view>使用预设的按钮样式：主按钮、次按钮、虚线按钮、文本按钮和链接按钮。推荐主按钮在同一个操作区域最多出现一次。</view>
            </view>
            ...
            <view class="code-box-description">
                ...
                <view>通过
                    <code>loading</code>
                    属性即可让按钮处于加载状态，最后1个按钮演示点击后进入加载状态。
                </view>
            </view>
            <view class="demo-wrap">
            ...
            <br />
            <br />
            <view>watch 函数学习</view>
            <XtxButton type="primary" @click="count++">Count++{{ count }}</XtxButton>
        </view>
    </view>
</template>
